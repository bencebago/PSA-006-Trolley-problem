...
#Demographcs and exclusion 

<!-- <Tamas> -->


#Main replication analysis
...
In all of the cultural clusters we investigated, we found strong evidence for the effect of personal force on moral dilemma judgements. 

<!-- //Robustness analysis <PBence> -->

<!-- //graph with exclusion -->
```{r Study1a excl graph, echo =FALSE }
...
```{r Study1a w/o excl graph, echo =FALSE }
...
<!-- //graph with exclusion -->
```{r Study1b excl graph, echo =FALSE }
...
<!-- //graph without exclusion -->
```{r Study1b w/o excl graph, echo =FALSE }
...
<!-- //graph with exclusion -->
```{r Study2a excl graph, echo =FALSE }
...
<!-- //graph without exclusion -->
```{r Study2a w/o excl graph, echo =FALSE }
...
<!-- //graph with exclusion -->
```{r study2b excl graph, echo =FALSE }
...
<!-- //graph without exclusion -->
```{r study2b w/o excl graph, echo =FALSE }
...
<!-- Bayesian country level individualism <MARCI> -->

<!-- Bayesian personal level individualism  <MARCI>-->
