...
trolley_raw <- read_csv(here("data/trolley_raw.csv"), guess_max = 10000)
trolley_proc <- read_csv(here("data/trolley_preprocessed.csv"), guess_max = 10000)
trolley <- read_csv(here("data/trolley.csv"), guess_max = 10000)
...
dat=subset(trolley_proc, survey==i,  select=c("trolley_3_rate", "trolley_4_rate", "trolley_5_rate", "trolley_6_rate", "country3", "familiarity"))
