...
```{r datatables, echo=FALSE,message=FALSE, warning=FALSE, paged.print=FALSE}
...
#use data study1a
tabledata_s1a = data.frame(Dilemma=c(rep("Trolley",3)),Cluster=c("Eastern", "Southern", "Western"), matrix(nrow=3, ncol=5, dimnames=list(survey,c("BF", "t", "df", "p"))))
...
tabledata_s1b = data.frame( Dilemma=c(rep("Speedboat",3)),Cluster=c("Eastern", "Southern", "Western"), matrix(nrow=3, ncol=5, dimnames=list(survey,c("BF", "t", "df", "p"))))
...
tabledata_s2a = data.frame(Dilemma=c(rep("Trolley",3)),Cluster=c("Eastern", "Southern", "Western"), matrix(nrow=3, ncol=5, dimnames=list(survey,c("BF", "F", "df", "p"))))
...
tabledata_s2b = data.frame(Dilemma=c("Speedboat", "Speedboat", "Speedboat"),Cluster=c("Eastern", "Southern", "Western"), matrix(nrow=3, ncol=5, dimnames=list(survey,c("BF","F", "df", "p"))))
for (i in survey){
