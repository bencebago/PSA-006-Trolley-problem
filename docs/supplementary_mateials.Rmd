...
trolley_raw <- read.csv("data/trolley_raw.csv")
trolley_proc <- read.csv("data/trolley_preprocessed.csv")
study1a <- read.csv("data/study1a.csv")
study1b <- read.csv("data/study1b.csv")
study2a <- read.csv("data/study2a.csv")
study2b <- read.csv("data/study2b.csv")
