...
Since the exclusion criteria clearly induced a selection and affected our results in unexpected ways, we decided to analyse all the data (without any exclusions) from now on.
