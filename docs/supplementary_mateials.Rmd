...
trolley_proc$survey_name=factor(trolley_proc$survey_name)
study1a$survey_name=factor(study1a$survey_name)
...
dat=subset(study_2a,  select=c("trolley_3_rate", "trolley_4_rate", "trolley_5_rate", "trolley_6_rate", "country3", vars))
